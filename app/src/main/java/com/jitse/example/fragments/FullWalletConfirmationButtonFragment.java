...
import com.jitse.example.activities.AndroidPayCompleteActivity;
import com.jitse.example.activities.CheckoutActivity;
 ...
 */
public class FullWalletConfirmationButtonFragment extends Fragment implements GoogleApiClient.ConnectionCallbacks,
     ...
     * {@link GooglePlayServicesUtil#getErrorDialog(int, Activity, int, DialogInterface.OnCancelListener)}. If an,
        ...
        if (mConnectionResult.hasResolution()) {
            ...
            if (GooglePlayServicesUtil.isUserRecoverableError(errorCode)) {
                Dialog dialog = GooglePlayServicesUtil.getErrorDialog(errorCode, getActivity(),
                        REQUEST_CODE_RESOLVE_ERR, new DialogInterface.OnCancelListener() {
    ...
    private void getFullWallet() {
        Wallet.Payments.loadFullWallet(mGoogleApiClient,
                createFullWalletRequest(mMaskedWallet.getGoogleTransactionId()),
    ...
    private void fetchTransactionStatus(FullWallet fullWallet) {
        ...
        Wallet.Payments.notifyTransactionStatus(mGoogleApiClient,
                createNotifyTransactionStatusRequest(fullWallet.getGoogleTransactionId(),
                        NotifyTransactionStatusRequest.Status.SUCCESS));

        Intent intent = new Intent(getActivity(), AndroidPayCompleteActivity.class);
    ...
    public NotifyTransactionStatusRequest createNotifyTransactionStatusRequest(
