...
public class SimpleSceneTransitionActivity extends ActionBarActivity {

    private static final String TAG = SimpleSceneTransitionActivity.class.getName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_simple_scene_transition);
    ...
    public void clicked(){
        Log.d(TAG, "onClicked");
        Intent intent = new Intent(this, SimpleSceneTransitionActivity.class);
